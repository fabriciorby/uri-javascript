...
class Tempo {
    ...
    timeTo(outroTempo) {
        ...
        let tempoInicioRelativo = new Tempo(this.hora - menorHora, this.minuto - menorMinuto);
        let tempoFinalRelativo = new Tempo(outroTempo.hora - menorHora, outroTempo.minuto - menorMinuto);

        if (tempoFinalRelativo.hora === 0)
            tempoFinalRelativo.hora = 24;
...
console.log('O JOGO DUROU ' + tempoTotal.hora + ' HORA(S) E ' + tempoTotal.minuto + ' MINUTO(S)');